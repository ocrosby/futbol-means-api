...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { AuthorizationsController } from './authorization.controller';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    ...
    "IPlayer": {
        ...
        "properties": {
            ...
            "jerseyNumber": {"dataType":"double","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/api/Authorizations/Login',
            ...(fetchMiddlewares<RequestHandler>(AuthorizationsController)),
            ...(fetchMiddlewares<RequestHandler>(AuthorizationsController.prototype.login)),

            function AuthorizationsController_login(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/api/Authorizations/Logout',
            ...(fetchMiddlewares<RequestHandler>(AuthorizationsController)),
            ...(fetchMiddlewares<RequestHandler>(AuthorizationsController.prototype.logout)),

            function AuthorizationsController_logout(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/api/api/players',
            ...
            function PlayersController_getPlayers(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/api/Users',
            ...
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.RegisterNewUser)),

            function UsersController_RegisterNewUser(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/api/Users/username/:username',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.GetUserByUsername)),

            function UsersController_GetUserByUsername(request: any, response: any, next: any) {
            const args = {
        ...
        app.patch('/api/Users',
            ...
            function UsersController_Update(request: any, response: any, next: any) {
            const args = {
